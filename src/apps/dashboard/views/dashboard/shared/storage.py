...
from apps.core.mixins.views import (FilterSimpleListViewMixin, DeleteViewMixin, UserRoleViewMixin)
from apps.storage import models


class GalleryImageList(UserRoleViewMixin, FilterSimpleListViewMixin, ListView):
...
class GalleryImageDelete(UserRoleViewMixin, DeleteViewMixin, View):
    role_access = ('super_user',)
